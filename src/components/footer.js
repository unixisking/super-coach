...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://facebook.com/louissainttraining',
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/louissainttraining/',
      // eslint-disable-next-line react/display-name
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-warm-gray-400 text-base">
              Suivez-nous sur les médias sociaux ci-dessous
            </p>
            <div className="flex space-x-6">
              {footerNavigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-warm-gray-400 hover:text-primary"
                >
        ...
        <div className="mt-12 border-t border-warm-gray-700 pt-8">
          <p className="text-base text-warm-gray-400 xl:text-center">
            &copy; 2021 Super Coach, Inc. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
