...
function IndexPage() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-black bg-opacity-70 absolute h-screen w-screen top-0 z-20" />
      ...
      >
        ...
        <Button style={{ marginTop: '1.5rem' }} text="Je réserve" />
      </motion.div>
        ...
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl ">
          ...
          >
            <div className="relative">
              <h3 className="text-2xl font-extrabold text-gray-200 tracking-tight sm:text-3xl">
